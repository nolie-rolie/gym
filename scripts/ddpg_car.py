# based on example: https://keras.io/examples/rl/ddpg_pendulum/
...
std_dev = 0.3
ou_noise = OUActionNoise(mean=np.ones(1)*0.4, std_deviation=float(std_dev) * np.ones(1))
...
plt.savefig('car_reward_plot.png')
